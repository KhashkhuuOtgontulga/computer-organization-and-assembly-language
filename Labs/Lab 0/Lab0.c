// Compile this file on fourier.cs.iit.edu with gcc -Wall -std=c99 -lm -o lab0 lab0.c
...
int main() {
  ...
  // single character.  You can use %p for pointers and memory addresses
  // An integer after the % specifies the width
  // of the output.
  //
  int x = 255;
  double rootx = sqrt(x);
